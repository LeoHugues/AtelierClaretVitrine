...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CoworkingContribRepository")
 * @Vich\Uploadable()
 */
class CoworkingContrib
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="coworking_image", fileNameProperty="imageHeader")
     */
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="coworking_image", fileNameProperty="imageVideo")
     */
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="coworking_image", fileNameProperty="imageKeynumber")
     */
