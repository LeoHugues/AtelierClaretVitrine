...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FablabContribRepository")
 * @Vich\Uploadable()
 */
class FablabContrib
{
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="fablab_image", fileNameProperty="imageHeader")
     */
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="fablab_image", fileNameProperty="imageVideo")
     */
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="fablab_image", fileNameProperty="imageKeynumber")
     */
